  ...
  <el-card class="box-card">
    ...
    <div style="margin: 20px">
      ...
      <el-descriptions
        ...
        :column="2"
      >
        <el-descriptions-item label="维修员所在单位">12</el-descriptions-item>
        <el-descriptions-item label="维修日期">2003-12-13</el-descriptions-item>
        <el-descriptions-item label="维修人"
          ><el-tag size="small">张三2</el-tag></el-descriptions-item
        >
        <el-descriptions-item label="维修人手机号"
          ><el-tag size="small">18888888888</el-tag></el-descriptions-item
        >
      </el-descriptions>
    </div>
  </el-card>
